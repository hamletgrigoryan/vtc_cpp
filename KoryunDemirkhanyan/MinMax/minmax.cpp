...
int main (int argc, char*argv[])
	{
		...
		std::cout<<"bool               ="<<sizeof(bool)<<"      "<<(pow(		2,sizeof(bool) * 8.0) - 1) << "            " << std::numeric_lim		its<bool>::min() << std::endl;

		std::cout<<"char               ="<<sizeof(char)<<"      "<<(pow(		2,sizeof(bool) * 8.0) - 1)  << "            " << std::numeric_li		mits<char>::min() << std::endl;
		...
		std::cout<<"unsigned int       ="<<sizeof(unsigned int)<<"      		"<<(pow(2,sizeof(unsigned int) * 8.0) - 1) << "    " << std::num		eric_limits<unsigned int>::min() << std::endl;

		std::cout<<"long int           ="<<sizeof(long int)<<"      "<<(		pow(2,sizeof(long int) * 8.0-1) - 1)  << "    "<< std::numeric_l		imits<long int>::min() << std::endl;
		...
		std::cout<<"double             ="<<sizeof(double)<<"      "<<(po		w(2,sizeof(double) * 8.0-1) - 1)  << "    "<< std::numeric_limit		s<double>::min() << std::endl;
		return 0;
	}
